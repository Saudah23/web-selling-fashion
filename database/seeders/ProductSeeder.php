    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                ...
                'description' => 'Genuine leather crossbody bag with adjustable strap. Perfect size for everyday essentials with multiple compartments.',
                ...
                'is_featured' => true,
                'sort_order' => 12,
                'category_id' => $categoryMap['tas'] ?? null,
                'attributes' => [
            ...
            // Accessories - Jam Tangan
            [
                'name' => 'Classic Watch',
                'description' => 'Elegant classic watch with stainless steel case and leather strap. Water-resistant design suitable for daily wear.',
                'short_description' => 'Elegant classic watch with leather strap',
                'sku' => 'ACC-WAT-013',
                'price' => 899000,
                'stock_quantity' => 12,
                'min_stock_level' => 2,
                ...
                'is_featured' => false,
                'sort_order' => 13,
                'category_id' => $categoryMap['jam-tangan'] ?? null,
                'attributes' => [
            ...
            [
                ...
                'short_description' => 'Classic cotton baseball cap',
                'sku' => 'ACC-CAP-014',
                'price' => 159000,
                'stock_quantity' => 30,
                'min_stock_level' => 6,
                ...
                'is_featured' => false,
                'sort_order' => 14,
                'category_id' => $categoryMap['topi'] ?? null,
                'attributes' => [
                    'material' => 'Cotton',
            ...
            [
                ...
                'description' => 'Classic aviator sunglasses with UV protection. Timeless design with metal frame and gradient lenses.',
                'short_description' => 'Classic aviator sunglasses with UV protection',
                'sku' => 'ACC-SUN-015',
                'price' => 299000,
                'compare_price' => 399000,
                'stock_quantity' => 20,
                ...
                'is_featured' => true,
                'sort_order' => 15,
                'category_id' => $categoryMap['kacamata'] ?? null,
                'attributes' => [
                    'frame_material' => 'Metal',
                    'lens_type' => 'Gradient',
                    'uv_protection' => '100%',
                    'colors' => ['Gold/Brown', 'Silver/Black', 'Black/Grey']
                ]
            ],

            // Accessories - Ikat Pinggang
            [
                'name' => 'Leather Belt',
                'description' => 'Premium leather belt with classic buckle. Versatile accessory suitable for both casual and formal wear.',
                'short_description' => 'Premium leather belt with classic buckle',
                'sku' => 'ACC-BEL-016',
                'price' => 189000,
                'stock_quantity' => 25,
                'min_stock_level' => 5,
                ...
                'is_featured' => false,
                'sort_order' => 16,
                'category_id' => $categoryMap['ikat-pinggang'] ?? null,
                'attributes' => [
                    'material' => 'Genuine Leather',
                    'sizes' => ['80cm', '90cm', '100cm', '110cm', '120cm'],
                    'colors' => ['Black', 'Brown', 'Tan']
                ]
            ],
