            ...
            <div class="checkout-section-card" id="shippingSection" style="display: none;">
              ...
              <div class="shipping-info-banner" id="shippingInfo" style="display: none;">
                <div class="shipping-detail">
                  <div class="shipping-detail-item">
                    ...
                    <span>Total Weight: <strong id="totalWeight">-</strong> gram</span>
                  </div>
                  <div class="shipping-detail-item">
                    <i class="fa fa-map-marker-alt text-success"></i>
                    <span>Destination: <strong id="destinationCity">-</strong></span>
                  </div>
                  <div class="shipping-detail-item">
                    <i class="fa fa-store text-info"></i>
                    <span>Origin: <strong>Indonesia</strong></span>
                  </div>
                </div>
              </div>
              ...
              <div id="shippingOptions">
                <div class="text-center py-4">
                  ...
                  <p class="mt-2 text-muted">Calculating shipping costs via RajaOngkir...</p>
                </div>
              </div>
            </div>
                ...
                <div class="order-item">
                  <div class="order-item-image">
                    @if($item->product->images->where('is_primary', true)->first())
                      <img src="{{ asset('storage/' . $item->product->images->where('is_primary', true)->first()->file_path) }}"
