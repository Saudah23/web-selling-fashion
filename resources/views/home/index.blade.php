              ...
              <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-6">
                  <div class="hero-img-wrap">
                    ...
                    <img src="{{ asset('storage/' . $banner->image) }}" class="img-fluid banner-image" alt="{{ $banner->title }}">
                    @else
                    <img src="{{ asset('furni-1.0.0/images/couch.png') }}" class="img-fluid banner-image" alt="{{ $banner->title }}">
                    @endif
                  </div>
                </div>
              </div>
  ...
  <div class="hero">
    <div class="container">
      <div class="row justify-content-between">
        <div class="col-lg-5">
          <div class="intro-excerpt">
            <h1>Modern Furniture <span class="d-block">Marketplace</span></h1>
            <p class="mb-4">Discover amazing furniture pieces with the best quality materials. Find everything you need to make your home beautiful and comfortable.</p>
            <p>
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-12 col-lg-3 mb-4 mb-lg-0">
          <div class="crafted-section-content">
            <h2 class="mb-3 section-title">Crafted with excellent material.</h2>
            <p class="mb-4">Our products are made from high-quality materials and designed to last. Each piece is carefully crafted to bring beauty and functionality to your space.</p>
            <p><a href="{{ route('shop') }}" class="btn">Explore All Products</a></p>
          </div>
        </div>
        <!-- End Column 1 -->
          ...
          <div class="product-card">
            ...
            <div class="product-image">
              <a href="{{ route('product.detail', $product->id) }}">
                ...
                @endphp
                @if($primaryImage)
                  <img src="{{ asset($primaryImage->url) }}"
                       class="img-fluid"
                       alt="{{ $product->name }}"
            ...
            <div class="product-info">
              ...
              <div class="product-actions mt-2">
                @if($product->stock_quantity > 0)
                  <button class="btn btn-cart" onclick="addToCartFromHome({{ $product->id }}, this)" data-product-id="{{ $product->id }}">
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 text-center mb-5">
          <h2 class="section-title">More Featured Products</h2>
        </div>
    ...
    <div class="container">
      <div class="row justify-content-between">
        <div class="col-lg-6">
          ...
          <p>We provide the best service and quality products for our customers. Here's what makes us special:</p>
          ...
          <div class="row my-5">
            <div class="col-6 col-md-6">
              <div class="feature">
                ...
                <p>Free shipping for orders above certain amount with fast delivery.</p>
              </div>
            </div>
            ...
            <div class="col-6 col-md-6">
              <div class="feature">
                ...
                <h3>Easy to Shop</h3>
                <p>Simple and intuitive shopping experience with secure payment.</p>
              </div>
            </div>
            ...
            <div class="col-6 col-md-6">
              <div class="feature">
                ...
                <h3>24/7 Support</h3>
                <p>Our customer support team is available to help you anytime.</p>
              </div>
            </div>
            ...
            <div class="col-6 col-md-6">
              <div class="feature">
                ...
                <p>Easy return process if you're not satisfied with your purchase.</p>
              </div>
            </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 text-center mb-5">
          ...
          <p class="text-muted">Discover our most loved product categories</p>
        </div>
      </div>
      <div class="row">
        <div class="col-6 col-md-6 col-lg-3 mb-4">
          <div class="category-showcase">
            ...
            <a href="{{ route('shop', ['category' => 1]) }}" class="btn btn-outline-pink">Explore</a>
          </div>
        </div>
        <div class="col-6 col-md-6 col-lg-3 mb-4">
          <div class="category-showcase">
            <div class="category-icon">
              <i class="fas fa-laptop fa-4x text-pink"></i>
            </div>
            <h4>Electronics</h4>
            <p>Latest gadgets and technology</p>
            <a href="{{ route('shop', ['category' => 2]) }}" class="btn btn-outline-pink">Explore</a>
          </div>
        </div>
        <div class="col-6 col-md-6 col-lg-3 mb-4">
          <div class="category-showcase">
            ...
            <h4>Home & Living</h4>
            <p>Beautiful furniture and decor</p>
            <a href="{{ route('shop', ['category' => 3]) }}" class="btn btn-outline-pink">Explore</a>
          </div>
        </div>
        <div class="col-6 col-md-6 col-lg-3 mb-4">
          <div class="category-showcase">
            <div class="category-icon">
              <i class="fas fa-heart fa-4x text-pink"></i>
            </div>
            <h4>Beauty</h4>
            <p>Skincare and cosmetics</p>
            <a href="{{ route('shop', ['category' => 4]) }}" class="btn btn-outline-pink">Explore</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row text-center">
        ...
        <div class="col-6 col-md-6 col-lg-3 mb-4">
          <div class="stat-item">
            ...
            <h5>Products</h5>
            <p class="text-muted">Quality products available</p>
          </div>
        </div>
        <div class="col-6 col-md-6 col-lg-3 mb-4">
          <div class="stat-item">
            ...
            <h5>Brands</h5>
            <p class="text-muted">Trusted brand partners</p>
          </div>
        </div>
        <div class="col-6 col-md-6 col-lg-3 mb-4">
          <div class="stat-item">
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 text-center mb-5">
          ...
          <p class="text-muted">Experience our products in person at our physical location</p>
        </div>
      </div>
      <div class="row">
        <!-- Contact Info -->
        <div class="col-lg-6 mb-4">
          <div class="contact-info">
            ...
            <div class="contact-item mb-3">
              ...
              <div>
                <h6>Email Address</h6>
                <p class="text-muted">{{ $systemSettings['contact_email'] ?: 'info@marketplace.com' }}</p>
              </div>
            </div>
            <div class="contact-item mb-3">
              ...
              <div>
                ...
                <p class="text-muted">
                  ...
                  @else
                    Monday - Friday: 09:00 - 18:00<br>Saturday: 09:00 - 15:00<br>Sunday: Closed
                  @endif
                </p>
              </div>
            </div>
        ...
        <div class="col-lg-6">
          <div class="map-container">
            ...
            <div class="directions-btn mt-3">
              <a href="https://maps.google.com?q={{ urlencode($shippingAddress['full_address']) }}" target="_blank" class="btn btn-outline-pink">
