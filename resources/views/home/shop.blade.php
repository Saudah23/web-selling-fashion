...
@section('title', 'Shop - Marketplace')
  ...
  <div class="page-header-bar">
    <div class="container">
      <div class="page-header">
        @if(request('wishlist'))
          <h4><i class="fas fa-heart text-danger me-2"></i>My Wishlist</h4>
      ...
      <div class="controls-bar">
        <div class="controls-wrapper">
          ...
          <div class="results-info">
            {{ $products->total() }} {{ request('wishlist') ? 'Wishlist Items' : 'Items' }}
          </div>
            ...
            <div class="product-info">
              ...
              <div class="product-actions mt-2">
                @if($product->stock_quantity > 0)
                  <button class="btn btn-cart" onclick="addToCartFromShop({{ $product->id }}, this)" data-product-id="{{ $product->id }}">
