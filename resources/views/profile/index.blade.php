...
@section('title', 'Profil Saya - FASHION SAAZZ')
...
@section('content')
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            ...
            <h6 class="op-7 mb-2">Kelola informasi akun dan keamanan Anda</h6>
        </div>
    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="profile-info">
                                        ...
                                        <div class="info-item mb-4">
                                            <label class="fw-bold text-muted">Alamat Email</label>
                                            <h5 class="mb-0">{{ $user->email }}</h5>
                                        </div>
                                        <div class="info-item mb-4">
                                            <label class="fw-bold text-muted">Tipe Akun</label>
                                            <h5 class="mb-0">
                                        ...
                                        <div class="info-item mb-4">
                                            <label class="fw-bold text-muted">Member Sejak</label>
                                            <h5 class="mb-0">{{ $user->created_at->format('F j, Y') }}</h5>
                                        </div>
                                        <div class="info-item mb-4">
                                            <label class="fw-bold text-muted">Status Email</label>
                                            <h5 class="mb-0">
                                                ...
                                                @else
                                                    <span class="badge badge-warning">
                                                        <i class="fas fa-exclamation-circle me-1"></i>Belum Terverifikasi
                                                    </span>
                                                @endif
                                            </h5>
                                        </div>
